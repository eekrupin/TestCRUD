    ...
    <table class="tg">
        ...
        <c:forEach items="${listUsers}" var="user">
            <tr>
                ...
                <td><a href="<c:url value='/userdata/${user.id}'/>">Detail</a></td>
            </tr>

            <c:if test="${firstId==0}">
                <c:set var = "firstId" value = "${user.id}"/>
            </c:if>

            <c:set var = "lastId" value = "${user.id}"/>
        </c:forEach>
    </table>
</c:if>
...
<c:url var="nextPage" value="/usersPage"/>
<form:form action="${nextPage}">
...
<td colspan="2">
    <input type="submit" name="previous" value="<spring:message text="previous"/>">
    ...
    <table>
        <c:if test="${!empty user.name}">
            <tr>
                ...
                <td>
                    <form:input path="id" type="number" readonly="true" size="8" disabled="true"/>
                    <form:hidden path="id"/>
                </td>
            </tr>
        </c:if>
